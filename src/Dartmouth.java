...
public class Dartmouth {
    ...
    public static void display(String a) {
        ...
        window.setTitle("Your Dartmouth Application");
        window.setResizable(false);

        Image dartmouthLogo = new Image("file:donotedit/Dartmouth.jpg");
        ImageView image = new ImageView();
        image.setImage(dartmouthLogo);
    ...
    private static void getRejectionText() {
        try {
            Scanner sc = new Scanner(new File("donotedit/DartmouthRejection.txt"));
    ...
    private static void getAcceptanceText() {
        try {
            Scanner sc = new Scanner(new File("donotedit/DartmouthAcceptance.txt"));
            letter.appendText("March 31, 2017");
            letter.appendText("\n\n");
            letter.appendText("Dear " + name + ",\n\n");
            while (sc.hasNext()) {
    ...
    private static void getWaitlistText() {
        try {
            Scanner sc = new Scanner(new File("donotedit/DartmouthWaitlist.txt"));
            letter.appendText("March 31, 2017");
            letter.appendText("\n\n");
            letter.appendText("Dear " + name + ",\n\n");
            while (sc.hasNext()) {
